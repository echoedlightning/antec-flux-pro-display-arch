...
```bash
curl -fsSL https://raw.githubusercontent.com/echoedlightning/antec-flux-pro-display-arch/main/install-arch.sh | bash
```
...
```bash
# One-line install
curl -fsSL https://raw.githubusercontent.com/echoedlightningantec-flux-pro-display-arch/main/install-arch.sh | bash

# Or download and inspect first
wget https://raw.githubusercontent.com/echoedlightning/antec-flux-pro-display-arch/main/install-arch.sh
...
```bash
# Download files
git clone https://github.com/echoedlightning/antec-flux-pro-display-arch.git
